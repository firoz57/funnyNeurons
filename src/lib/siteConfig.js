export const SITE_URL = 'https://funnyneurons.netlify.app';
export const APPROVED_POSTERS_GH_USERNAME = ['firoz57'];
export const GH_USER_REPO = 'firoz57/funnyNeurons'; // used for pulling github issues and offering comments
export const SITE_TITLE = 'Funny Neurons';
